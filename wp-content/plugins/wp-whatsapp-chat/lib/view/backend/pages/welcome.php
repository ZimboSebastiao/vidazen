  ...
  <div class="has-2-columns is-wider-left" style="max-width: 100%">
	<div class="column">
	  <div class="welcome-header">
		<h1><?php echo esc_html( QLWAPP_PLUGIN_NAME ); ?> <span style="font-size: 24px;color: #555;">v<?php echo QLWAPP_PLUGIN_VERSION; ?></span></h1>
	  ...
	  <div class="feature-section" style="margin: 15px 0;">
		...
		<a style="background-color: #ffffff;color: #626262;text-decoration: none;padding: 10px 30px;border-radius: 30px;margin: 10px 0 0 0;display: inline-block;" target="_blank" href="<?php echo esc_url( QLWAPP_SUPPORT_URL ); ?>"><?php esc_html_e( 'Submit ticket', 'wp-tiktok-feed' ); ?></a>
	  </div>
	  <div class="feature-section" style="margin: 15px 0;">
	...
	<div class="column">
	  <img alt="<?php echo esc_html( QLWAPP_PLUGIN_NAME ); ?>" src="<?php echo plugins_url( '/assets/backend/img/box1.png', QLWAPP_PLUGIN_FILE ); ?>">
	</div>
  </div>
</div>
